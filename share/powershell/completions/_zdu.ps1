...
Register-ArgumentCompleter -Native -CommandName 'zdu' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'zdu' {
            ...
            [CompletionResult]::new('-I', '-I ', [CompletionResultType]::ParameterName, 'Exclude any file or directory with a regex matching that listed in this file, the file entries will be added to the ignore regexs provided by --invert_filter. Blank lines and lines starting with ''#'' are skipped')
            [CompletionResult]::new('--ignore-all-in-file', '--ignore-all-in-file', [CompletionResultType]::ParameterName, 'Exclude any file or directory with a regex matching that listed in this file, the file entries will be added to the ignore regexs provided by --invert_filter. Blank lines and lines starting with ''#'' are skipped')
            ...
            [CompletionResult]::new('-s', '-s', [CompletionResultType]::ParameterName, 'Use file length instead of blocks (on Windows the default mode is the on-disk size, which equals file length for plain files)')
            [CompletionResult]::new('--apparent-size', '--apparent-size', [CompletionResultType]::ParameterName, 'Use file length instead of blocks (on Windows the default mode is the on-disk size, which equals file length for plain files)')
