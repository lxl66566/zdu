...
set edit:completion:arg-completer[zdu] = {|@words|
    fn spaces {|n|
    ...
    var completions = [
        &'zdu'= {
            ...
            cand -I 'Exclude any file or directory with a regex matching that listed in this file, the file entries will be added to the ignore regexs provided by --invert_filter. Blank lines and lines starting with ''#'' are skipped'
            cand --ignore-all-in-file 'Exclude any file or directory with a regex matching that listed in this file, the file entries will be added to the ignore regexs provided by --invert_filter. Blank lines and lines starting with ''#'' are skipped'
            ...
            cand -s 'Use file length instead of blocks (on Windows the default mode is the on-disk size, which equals file length for plain files)'
            cand --apparent-size 'Use file length instead of blocks (on Windows the default mode is the on-disk size, which equals file length for plain files)'
